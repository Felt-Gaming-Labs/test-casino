...
export const GAMES: GameBundle[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      name: "Dice",
      image: "/games/logo.png",
      description: `Select a number and aim to roll below it to win. Adjusting your choice affects potential payouts, things can get dicey but you know that already.`,
    },
  ...
  },
  {
    ...
    meta: {
      ...
      name: "Slots",
      image: "/games/logo.png",
      description: `Spin 2 win. Try to hit the 7x and try not to get wasted.`,
    },
